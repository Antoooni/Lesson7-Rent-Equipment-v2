...
import by.htp.Lesson7.equipment.service.RentStationServiceFile;
import by.htp.Lesson7.equipment.service.RentStationServiceFileImpl;
...
public class TestRent {
	...
	public static void main(String[] args) {
		...
		RentStationServiceFile rentStationServiceFile = new RentStationServiceFileImpl();
		
		Manager stock= new Manager();
		stock.setNameManager(rentStationServiceFile.getManagerName());//read manager from file
		stock.setIdManager(rentStationServiceFile.getManagerId());
		...
		String findBrand = rentStationServiceFile.getFoundBrand();
		RentUnit[] found=rentStationSevice.searchItem(findBrand, false);
		
		Client c1= new Client();
		c1.setName(rentStationServiceFile.getClientName());
		c1.setId(rentStationServiceFile.getClientId());
		c1.getRentedClientGoods();
		RentUnit [] addedClientGoods=	c1.addRentedGoods(found); // client rented items 
